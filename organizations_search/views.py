...
class organizationSearchValue(APIView):
    "Get list of searchable values"
    ...
    def get(self, request, value_name):
        ...
        if value_name in result.keys():
            if 'value' in request.query_params.keys():
                ...
                if value_name in ['shared_tickets']:
